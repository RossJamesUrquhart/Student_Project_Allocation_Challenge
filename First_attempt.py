...
#         #print(x)
#         student = x
#         pick = student_choices_list[student[0]][choice]
#     
#         if pick in projs:
#             #print(f"Student {x} has been assigned Project Number {student_choices_list[student][choice]}")
#             #projects.drop(labels=[student_choices_list[student][choice]])
#             print(len(projs))
#             assigned_choices.append([x, pick])
#             projs.remove(pick)
#             
#         elif pick not in projs:
#             choice += 1
#             continue
# =============================================================================
...
print([[x,score_list.count(x)] for x in set(score_list)])
print("========================================================================")
print("========================================================================")
print(f"Of {number_of_students} students, {round((score_list.count(1)/number_of_students)*100,2)}% of students got their first pick")
print(f"Of the remaining {number_of_students - score_list.count(1)} students, {round((score_list.count(2)/(number_of_students - score_list.count(1)))*100, 2)}% of students got their second pick")
print(f"Of the remaining {number_of_students - score_list.count(1) - score_list.count(2)} students, {round((score_list.count(3)/(number_of_students - score_list.count(1) - score_list.count(2)))*100, 2)}% of students got their third pick")
print(f"Of the remaining {number_of_students - score_list.count(1) - score_list.count(2) - score_list.count(3)} students, {round((score_list.count(4)/(number_of_students - score_list.count(1) - score_list.count(2) - score_list.count(3)))*100, 2)}% of students got their fourth pick")
print("========================================================================")
print("========================================================================")
